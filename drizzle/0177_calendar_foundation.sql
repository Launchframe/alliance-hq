CREATE TABLE IF NOT EXISTS train_boarding_windows (
...
CREATE INDEX IF NOT EXISTS train_boarding_alliance_idx ON train_boarding_windows(alliance_id, status);
...
CREATE INDEX IF NOT EXISTS calendar_target_due_idx ON calendar_targets(provider, next_sync_at);
