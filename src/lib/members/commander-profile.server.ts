...
export async function loadCommanderProfile(
  ...
  const vrRows = commanderIdentity
    ? await db
        .select()
  ...
  return {
    member: {
      ...
      totalHeroPower: commanderIdentity?.currentTotalHeroPower ?? null,
      memberLevel: commanderIdentity?.memberLevel ?? null,
      ...
      country: commanderIdentity?.country ?? null,
    },
    alliance,
    hqUser,
