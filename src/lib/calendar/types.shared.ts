...
export type CalendarSettingsData = {
  ...
  targets: Array<{ id: string; allianceId: string; provider: string; sources: CalendarSource[]; enabled: boolean; version: number; status: string; cleanup: boolean; lastSyncAt: string | null; lastFetchAt: string | null }>;
