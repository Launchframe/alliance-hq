...
/** Highest self-reported base VR per commander per game season (portable across alliances). */
...
/** Commander-scoped VR event timeline (follows commander across alliance transfers). */
...
/**
 * Weekly VS minimum compliance evaluation per member (PR3). One row per
