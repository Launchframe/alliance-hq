...
const MESSAGES: Record<DiscordBotLocale, Record<string, unknown>> = {
  "en-US": { ...enUS.discordBot, teamWork: enUS.teamWork, trainDuty: enUS.trains.conductorHistory, timeOff: { ...enUS.discordBot.timeOff, workflow: enUS.timeOff.workflow, form: enUS.timeOff.form, officerModal: enUS.timeOff.officerModal, entry: enUS.timeOff.entry, sync: enUS.timeOff.sync } },
  "pt-BR": { ...ptBR.discordBot, teamWork: ptBR.teamWork, trainDuty: ptBR.trains.conductorHistory, timeOff: { ...ptBR.discordBot.timeOff, workflow: ptBR.timeOff.workflow, form: ptBR.timeOff.form, officerModal: ptBR.timeOff.officerModal, entry: ptBR.timeOff.entry, sync: ptBR.timeOff.sync } },
};
