...
describe("canStampVideoJobReviewOpened", () => {
  it("allows review and failed only", () => {
    expect(canStampVideoJobReviewOpened("review")).toBe(true);
    expect(canStampVideoJobReviewOpened("failed")).toBe(true);
    expect(canStampVideoJobReviewOpened("complete")).toBe(false);
    expect(canStampVideoJobReviewOpened("parsing")).toBe(false);
  });
});
