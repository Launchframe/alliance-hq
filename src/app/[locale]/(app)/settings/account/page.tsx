...
export default async function AccountSecurityPage({
  ...
  const calendar = await getTranslations({ locale, namespace: "calendarConnections" });
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6">
      ...
      <Link href="/account/calendars" className="block rounded-xl border border-hq-border bg-hq-surface p-4 text-hq-accent underline">{calendar("title")}</Link>
