    ...
    return (
      <div className="space-y-5">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-hq-fg-muted">{t("thankYouDescription")}</p>
        </div>

        <div className="rounded-xl border border-hq-border bg-hq-canvas px-4 py-6 text-center">
          <img
          ...
          />
          <p className="mt-4 text-sm leading-relaxed text-hq-fg">
            {t("discordFollowUp")}
          </p>
          {onJoinDiscord ? (
    ...
    <>
      ...
      >
        ...
        <label className="block space-y-1 text-sm">
          <span className="text-hq-fg-muted">{t("area")}</span>
          <AppSelect
            value={area}
        ...
        <label className="block space-y-1 text-sm">
          <span className="text-hq-fg-muted">{t("severity")}</span>
          <AppSelect
        ...
        <label className="block space-y-1 text-sm">
          <span className="text-hq-fg-muted">{t("subject")}</span>
          <input
        ...
        <label className="block space-y-1 text-sm">
          <span className="text-hq-fg-muted">{t("details")}</span>
          <Textarea
            value={description}
