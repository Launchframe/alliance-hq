...
/**
 * Mobile: stacked record cards. md+: desktop table. Callers that need a
 * horizontal scrollport should wrap the table themselves so nested
 * overflow-x-auto regions are not stacked.
 */
