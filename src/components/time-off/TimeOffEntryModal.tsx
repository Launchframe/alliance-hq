...
const fieldClassName =
  "mt-1 w-full rounded border border-hq-border bg-hq-surface px-2 py-2 text-sm text-hq-fg";
      ...
      >
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button
            ...
            onClick={onClose}
            disabled={saving}
            className="rounded border border-hq-border bg-hq-surface px-3 py-2 text-sm text-hq-fg"
          >
