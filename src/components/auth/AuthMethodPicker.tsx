...
import type { SignInMethodLinkedFlags } from "@/lib/auth/sign-in-method-linked.shared";
...
export function MethodPickerButton({
  label,
  disabled,
  linked,
  onClick,
...
type AuthMethodPickerRowProps = {
  ssoAvailability: AuthSsoAvailability;
  linkedState?: SignInMethodLinkedFlags;
  disabled?: boolean;
  showEmail?: boolean;
  ariaLabel: string;
  labels: {
...
export function AuthMethodPickerRow({
  ssoAvailability,
  linkedState,
  disabled,
  showEmail = true,
